...
<head>
    ...
    <link rel="icon" href="images/UPGov.png" type="image/x-icon">
    ...
    <script>
        ...
        function changeTheme(color) {
            ...
            document.body.classList.remove('red-theme', 'green-theme', 'blue-theme');

            // Add the appropriate theme class based on the color parameter
            if (color === 'red') {
                    ...
                    <div class="col-xs-12">
                        <div class="push-right" aria-label="Primary">
                            <div id="accessibility">
                                <ul id="accessibilityMenu" class="clearfix">
                                    <li class="switchTheme">
                                        <span class="fa fa-circle" style="color: maroon;" onclick="changeTheme('red');" title="Maroon theme"></span>
                                        &nbsp;&nbsp;
                                        <span class="fa fa-circle" style="color: green;" onclick="changeTheme('green');" title="Green theme"></span>
                                        &nbsp;&nbsp;
                                        <span class="fa fa-circle" style="color: #062F4F;" onclick="changeTheme('blue');" title="Default theme"></span>
                                    </li>
                                    <li>
                                    ...
                                    <li class="social-media">
                                        ...
                                        <ul class="socialIcons">
                                            <li>
                                                <a href="#" target="_self" aria-label="Facebook | External site that opens in a new window">
                                                    <img src="images/facebook_icon.svg" title="Facebook | External site that opens in a new window" alt="Facebook, External Link that opens in a new window"></a>
                                            </li>
                                            <li>
                                                <a href="#" target="_self" aria-label="Twitter | External site that opens in a new window">
                                                    <img class="twitter" src="images/twitter_icon.svg" title="Twitter | External site that opens in a new window" alt="Twitter, External Link that opens in a new window"></a>
                                            </li>
                                            <li>
                                                <a href="#" target="_self" aria-label="Youtube | External site that opens in a new window">
                                                    <img src="images/youtube_icon.svg" title="Youtube | External site that opens in a new window" alt="youtube, External Link that opens in a new window"></a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="languageCont" aria-label="Change Language">
                                        ...
                                        <ul class="socialIcons">
                                            <li class="lang-item lang-item-55 lang-item-hi mFocus">
                                                <a lang="hi" hreflang="hi-IN" href="index-hi.aspx" aria-label="हिन्दी" title="हिन्दी">हिन्दी</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="push-left">
                            <div class="govBranding">
                                <ul>
                                    <li>
                                        <a lang="hi" href="https://up.gov.in/hi">उत्तर प्रदेश सरकार
                                        </a>
                                    </li>
                                    <li>
                                        <a lang="en" href="https://up.gov.in/en">Government of Uttar Pradesh
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                        <div class="logo">
                            <a href="index.aspx" title="Go to home" class="site_logo" rel="home">
                                <img class="emblem" src="images/UPGov.png" alt="UP state emblem">
                                <div class="logo_text">
                                    <strong lang="hi">छात्रवृत्ति एवं शुल्क प्रतिपूर्ति ऑनलाइन प्रणाली</strong>
                    ...
                    <div class="col-xs-12">
                                ...
                                <div class="vc_column-inner vc_custom_1530876290014">
                                    <div class="wpb_wrapper">
                                        <div id="slide" class="home-slider full-cntrl-left-caption-right nav-white  flexslider ">
                                            <ul class="slides">
                                                <li>
                                                    <img src="images/Banner01.png" oncontextmenu="return false" style="min-height: 120px;" alt="sdbanner1">
                                                </li>
                                                <li>
                                                    <img src="images/Banner02.png" oncontextmenu="return false" style="min-height: 120px;" alt="sdbanner2">
                                                </li>
                                                <li>
                                                    <img src="images/Banner03.png" oncontextmenu="return false" style="min-height: 120px;" alt="sdbanner3">
                                                </li>
                                                <li>
                                                    <img src="images/Banner04.png" oncontextmenu="return false" style="min-height: 120px;" alt="sdbanner4">
                                                </li>
                                                <li>
                                                    <img src="images/Banner05.png" oncontextmenu="return false" style="min-height: 120px;" alt="sdbanner5">
                                                </li>
                                                <li>
                                                    <img src="images/2018070674.jpg" oncontextmenu="return false" style="min-height: 120px;" alt="sdbanner6">
                                                    <%--<div class="container">
                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="news-ticker-horizontal viewall-with-cntrls nth-flexslider color-white  title-left show-controls   ">
                                            ...
                                            <div class="newsticker flexslider pd-15">
                                                <ul class="slides">
                                                    <li>
                                                        <a class="with-urlchange" href="https://resident.uidai.gov.in/bank-mapper" target="_blank">
                                                            <img src="https://scholarship.up.gov.in/imagesnew/new-icon.gif" style="height: 15px; width: 35px;">
                                                            <span class="fa fa-hand-o-right" style="color: white;"></span>&nbsp;&nbsp; कॉलेज द्वारा मास्टर डाटा लॉक करने की अंतिम तिथि 15 जनवरी  2024
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="with-urlchange" href="https://resident.uidai.gov.in/bank-mapper" target="_blank">
                                                            <img src="https://scholarship.up.gov.in/imagesnew/new-icon.gif" style="height: 15px; width: 35px;">
                                                            <span class="fa fa-hand-o-right" style="color: white;"></span>&nbsp;&nbsp; अपनी आधार सीडिंग की स्थिति जांचें। 
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="with-urlchange" href="#">
                                                            <span class="fa fa-hand-o-right" style="color: white;"></span>&nbsp;&nbsp;नवीनीकरण (Renewal)के सभी छात्र /छात्रा छात्रवृत्ति हेतु आनलाइन आवेदन बिना रजिस्ट्रेशन के सीधे भरें।
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="with-urlchange" href="#">
                                                            <span class="fa fa-hand-o-right" style="color: white;"></span>&nbsp;&nbsp; समस्त छात्र-छात्राएं जिन्होंने अभी तक अपने बैंक खाते में  आधार सीडिंग नहीं कराया है, तत्काल अपने संचालित बैंक खाते में आधार सीडिंग करा लें।
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="with-urlchange" href="https://pfms.nic.in/static/NewLayoutCommonContent.aspx?RequestPagename=static/KnowYourPayment_new.aspx">
                                                            <span class="fa fa-hand-o-right" style="color: white;"></span>&nbsp;&nbsp;अपनी भुगतान की स्थिति जानने के लिए क्लिक करें 
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="vc_row wpb_row vc_row-fluid">
                            <div class="wpb_column vc_column_container vc_col-sm-4">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="vc_col-sm-12 bgtheme" style="color: white; margin: 5px 5px 0 0;">
                                            ...
                                            <table style="font-family: 'Roboto', sans-serif;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><b>REVISED POSTMATRIC SCHOLARSHIP MASTER DATA TIME-TABLE</b></td>
                                                        <td>26-04-2024</td>
                                                        <td class="text-center"><a href="pdfs/exttimetable29.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">2</td>
                                                        <td><b>POSTMATRIC SCHOLARSHIP TIME-TABLE FOR SC AND ST CATEGORY</b></td>
                                                        <td>11-01-2024</td>
                                                        <td class="text-center"><a href="pdfs/ST, ST time table.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                        <tr>
                                                            <td class="text-center" style="min-width: 25px;">3</td>
                                                            <td><b>POSTMATRIC SCHOLARSHIP TIME-TABLE FOR OBC,GENERAL and MINORITY CATEGORY</b></td>
                                                            <td>11-01-2024</td>
                                                            <td class="text-center"><a href="pdfs/Gen, OBC, Min time table.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                        </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">4</td>
                                                        <td><b>REVISED PREMATRIC SCHOLARSHIP TIME-TABLE</b></td>
                                                        <td>05-01-2024</td>
                                                        <td class="text-center"><a href="pdfs/Prematric time table 2023-24 ext.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">5</td>
                                                        <td><b>REVISED PREMATRIC SCHOLARSHIP TIME-TABLE</b></td>
                                                        <td>10-11-2023</td>
                                                        <td class="text-center"><a href="pdfs/Prematric timetble 1011 2023.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">6</td>
                                                        <td><b>POSTMATRIC SCHOLARSHIP TIME-TABLE FOR SC AND ST CATEGORY</b></td>
                                                        <td>15-09-2023</td>
                                                        <td class="text-center"><a href="pdfs/Postmatric time table sc st 15 September.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">7</td>
                                                        <td><b>POSTMATRIC SCHOLARSHIP TIME-TABLE FOR OBC,GENERAL and MINORITY CATEGORY</b></td>
                                                        <td>15-09-2023</td>
                                                        <td class="text-center"><a href="pdfs/Postmatric time table Gen obc min 15 September.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">7</td>
                                                        <td><b>REVISED PREMATRIC SCHOLARSHIP TIME-TABLE</b></td>
                                                        <td>21-08-2023</td>
                                                        <td class="text-center"><a href="pdfs/Prematric Time Table 2023-24 revised.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 25px;">7</td>
                                                        <td><b>PREMATRIC SCHOLARSHIP TIME-TABLE</b></td>
                                                        <td>28-07-2023</td>
                                                        <td class="text-center"><a href="pdfs/Prematric Time Table 2023-24.pdf" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="vc_tta-container" data-vc-action="collapse">
                                            <div class="vc_general vc_tta vc_tta-tabs vc_tta-color-grey vc_tta-style-classic vc_tta-shape-rounded vc_tta-spacing-1  tabstyle-eight vc_tta-tabs-position-top vc_tta-controls -align-left">
                                                <div class="vc_tta-tabs-container dtp-view">
                                                ...
                                                <div class="vc_tta-panels-container phone-view">
                                                                            ...
                                                                            <div class="colspexp-container">
                                                                                ...
                                                                                <div class="colspexp_content">
                                                                                    <div style="margin: 10px; width: 96%">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp; Registration</td>
                                                                                                <td><h6 class="m0" style="word-wrap:normal !important;">Start From : 10-August-2023</h6></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-sign-in" style="color:blue;"></span> &nbsp;&nbsp; Login</td>
                                                                                                <td><h5 class="m0">Login if you have already registered.</h5></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="colspexp_content">
                                                                                    <div style="margin: 10px; width: 96%">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp; Registration</td>
                                                                                                <td><h6 class="m0" style="word-wrap:normal !important;">Start From : 22-Sept-2023</h6></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-sign-in" style="color:blue;"></span> &nbsp;&nbsp; Login</td>
                                                                                                <td><h5 class="m0">Login if you have already registered.</h5></td>
                                                                                ...
                                                                                <div class="colspexp_content">
                                                                                    <div style="margin: 10px; width: 96%">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <a href="pdfs/Adobe Scan 28-Sept-2023 sc and other pre.pdf">
                                                                                                    <span class="fa fa-file-text" style="color:green;"></span>नियमावली 2023 (जारी तिथि -27 /09 /2023 ) <span class="fa fa-download" style="color:green;"></span>
                                                                                                        </a>
                                                                                                </td>  
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp;   नियमावली 2016 (जारी तिथि -16 /03 /2016 ) <span class="fa fa-download" style="color:green;"></span>
                                                                                                </td>  
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
                                                                            ...
                                                                            <div class="colspexp-container">
                                                                                ...
                                                                                <div class="colspexp_content">
                                                                                    <div style="margin: 10px; width: 96%">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp;    नियमावली 2023 (जारी तिथि - 27 /09 /2023) <span class="fa fa-download" style="color:green;"></span></td>  
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp;   नियमावली 2016 (जारी तिथि -16 /03 /2016 ) <span class="fa fa-download" style="color:green;"></span></td>  
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="colspexp-container">
                                                                                ...
                                                                                <div class="colspexp_content">
                                                                                    <div style="margin: 10px; width: 96%">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp;     नियमावली 2016 (जारी तिथि - 12 /04 /2016)  <span class="fa fa-download" style="color:green;"></span></td>  
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="colspexp-container">
                                                                                ...
                                                                                <div class="colspexp_content">
                                                                                    <div style="margin: 10px; width: 96%">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td><span class="fa fa-file-text" style="color:green;"></span> &nbsp;&nbsp;   -----<span class="fa fa-download" style="color:green;"></span></td>  
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
                                                                                </div>
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="gen-list  no-border no-bg padding-3 border-radius-none iconTop-textBottom-box-list  col-three normal-font ">
                                            <div class="vc_col-sm-12 bgtheme" style="color: white; margin: 2px 0 5px 0;">
                                                <h2>Login Portals</h2>
                                            </div>
                                                ...
                                                <center>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='students.aspx'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%201.png" /></center>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='institutes.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%202.png" /></center>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Univ_login_SM.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%203.png" /></center>
                                                                <%-- <span class="fa fa-institution" style="font-size: 30px;"></span>
                                                            <h3>Institutes</h3>--%>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Dios_Login.aspx'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%205.png" /></center>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Dsw_Obc_Dmo_Login.aspx?a=SW'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%206.png" /></center>
                                                                <%--<span class="fa fa-users" style="font-size: 30px;"></span>
                                                            <h3>Students</h3>--%>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='dwbmo_Login.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%207.png" /></center>
                                                                <%-- <span class="fa fa-institution" style="font-size: 30px;"></span>
                                                            <h3>Institutes</h3>--%>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Mandal_Login.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%204.png" /></center>
                                                                <%-- <span class="fa fa-institution" style="font-size: 30px;"></span>
                                                            <h3>Institutes</h3>--%>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='osInst_login.aspx'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center>
                                                                    <img class="img-responsive" src="images/Icons/Group%209.png" /></center>
                                                                <%--<span class="fa fa-graduation-cap" style="font-size: 30px;"></span>
                                                            <h3>Universities</h3>--%>
                                                            </div>
                                                        </div>
                        ...
                        <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid accent-fixed-color tab-rowbg-home8 vc_custom_1579691374150 vc_column-gap-30">
                            <div class="wpb_column vc_column_cont4iner vc_col-sm-4">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="vc_col-sm-12 bgtheme" style="color: white; margin: 5px 0 0 0;">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody style="background: white; color: black;">
                                                    <tr>
                                                        ...
                                                        <td><b>General Instruction for Students</b></td>
                                                        <td class="text-center"><a href="pdfs/छात्रा हेतु महत्त्वपूर्ण निर्देश .pdf" title="Download"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 10px; max-width: 15px;">2</td>
                                                        <td><b>General Instructions for Outside State Institutions/Students</b></td>
                                                        <td class="text-center"><a href="pdfs/प्रदेश से बाहर अध्ययनरत उत्तर प्रदेश .pdf" title="Download"><span class="fa fa-download"></span></a></td>
                                                        <tr>
                                                            <td class="text-center" style="min-width: 10px; max-width: 15px;">3</td>
                                                            <td><b>OUTSIDE STATE INSTITUTIONS REGISTRATION FORM--हिंदी </b></td>
                                                            <td class="text-center"><a href="pdfs/Application form 2020-21 OUT OF STATE (4).docx" title="Download"><span class="fa fa-download"></span></a></td>
                                                        </tr>
                                                    <tr>
                                                        <td class="text-center" style="min-width: 10px; max-width: 15px;">4</td>
                                                        <td><b>Advertisement Session 2023-2024</b></td>
                                                        <td class="text-center"><a href="pdfs/Advertisement 2023-24.pdf" title="Download"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="wpb_column vc_column_cont4iner vc_col-sm-8">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="vc_col-sm-12 bgtheme" style="color: white; margin: 5px 0 0 0;">
                                            <h2 style="position: sticky; top: 0; z-index: 1;">List of Blacklisted Institutes</h2>
                                        </div>
                                        <div style="width: 100%; max-height: 255px; overflow-x: hidden; overflow-y: scroll;">
                                            <table class="table table-bordered table-hover" style="margin-bottom: 0px; height: 175px;">
                                                <thead style="position: sticky; top: 0; z-index: 1;color:black;">
                                                    <tr>
                                                        <th>DISTRICT</th>
                                                        <th>INSTITUTE</th>
                                                        <th>ORDER DATE</th>
                                                ...
                                                <tbody style="background: white; color: black;">
                                                    ...
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>राजवीर सिंह सिकरवार प्राइवेट आई0टी0आई0, सैदपुर बल्देव</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>पण्डित एन0आर0 प्राइवेट आई0टी0आई0, अडुकी</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>गोपाल प्राइवेट आई0टी0आई0, छरोरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>एच0पी0आर0ए0 प्राइवेट आई0टी0आई0, मदोरा, बल्देव</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>एस0आर0एल0 प्राइवेट आई0टी0आई0, पंडवा, मांट</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>एस0जी0एस0 प्राइवेट आई0टी0आई0, जाजमपट्टी, रसूलपुर</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>श्री जे0एस0 प्राइवेट आई0टी0आई0, आमेरपुर, बल्देव</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>श्रीमती धरमवती भेड़जीत सिंह प्राइवेट आई0टी0आई0, बरौली, बल्देव, महावन</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>चन्दनवन प्राइवेट आई0टी0आई0, भरतपुर</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>जी0 सिटी प्राइवेट आई0टी0आई0, नटवर नगर</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>केशव देव प्राइवेट आई0टी0आई0, लोरिहा पट्टी, सौंख</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>रतन प्राइवेट आई0टी0आई0, महावन</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>श्री प्रेम सिंह मुखिया प्राइवेट आई0टी0आई0, कुम्हेर रोड, सौंख</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>श्री हरदम सिंह वैदिक प्राइवेट आई0टी0आई0, नूरपुर, महावन, बल्देव</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>श्रीमती विमला देवी प्राइवेट आई0टी0आई0, भदर सांेख, गोवर्धन</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>बाबा हरचन्द सिंह प्राइवेट आई0टी0आई0, पवन कंुज</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>लोटस प्राइवेट आई0टी0आई0, कोसीखुर्द</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>समर्थ प्राइवेट आई0टी0आई0, सुन्दरवन</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>श्री एस0एल0 प्राइवेट आई0टी0आई0, अनौरा, महावन</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>पण्डित गोविन्द राम प्राइवेट आई0टी0आई0, राल</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>चमेली देवी प्राइवेट आई0टी0आई0, बंादी, महावन</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>एम0वी0डी0 प्राइवेट आई0टी0आई0, नगला देविया</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>श्रीमती शान्ति देवी प्राइवेट आई0टी0आई0, इंदावली, महावन</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>श्री नत्थी सिंह प्राइवेट आई0टी0आई0, ग्राम-बलरई पो0-बरारी</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>उन्नति फार्मेसी कालेज, दीन दयाल धाम रोड, दौलतपुर, फरह</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>उन्नति मैनेजमेन्ट कालेज, दीन दयाल धाम रोड, फरह</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>आर0बी0एस0 कालेज आफ फार्मेसी, बाद,</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>के0के0 कालेज, गुरूकुल</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>श्रीमती लीला देवी (पी0जी0) कालेज, मगना, बल्देव</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>चौधरी चिरंजी लाल कालेज आफ फार्मेसी, महावन</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>एस0आर0सी0 फार्मेसी कालेज, रसूलपुर, गोवर्धन</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>बी0एस0एम0 कालेज आफ टेक्नालाजी एण्ड मैनेजमेन्ट, भदर, सोन</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>ओ0डी0एम0 कालेज आफ फार्मेसी, कोयल राया</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>आर0एस0एस0 कालेज आफ फार्मेसी</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>सी0सी0एल0 कालेज, अड्डाकरब</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>एस0एस0के0डी0 कालेज आफ फार्मेसी, मांट</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>माधव कालेज आफ फार्मेसी, पंडवा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>अमर प्राइवेट आई0टी0आई0, मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>बृजधाम प्राइवेट आई0टी0आई0, मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>सी0सी0एल0 प्राइवेट आई0टी0आई0, मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>रामवती देवी प्राइवेट आई0टी0आई0, मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>आर0के0 प्राइवेट आई0टी0आई0, महावन</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>माँ राम दुलारी कालेज, ओल, मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>निखिल इंस्टी0 आफ इंजी0 एण्ड मैने0 मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>आर0डी0 प्राइवेट आई0टी0आई0, छाता</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>एस0डी0 प्राइवेट आई0टी0आई0, मांट मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>श्री शिवम प्राइवेट आई0टी0आई0, मथुरा</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>आचार्य चौब सिंह प्राइवेट आई0टी0आई0,</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>राम हरि सिसोदिया प्राइवेट आई0टी0आई0, अकबरपुर</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>जी0जी0 प्राइवेट आई0टी0आई0, छाता</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>फतेह सिंह प्राइवेट आई0टी0आई0, नगला राय सिंह, पचावर</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>श्रीमती जमुना देवी प्राइवेट आई0टी0आई0, भदर, सौंख</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>श्री गिर्राज महाराज प्राइवेट आई0टी0आई0</td><td>03-05-2023</td></tr>-->
                                                    <!--<tr><td>मथुरा</td><td>आर0एस0एस0 प्राइवेट आई0टी0आई0, सैदपुर बल्देव</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>आर0बी0एस0एस0 प्राइवेट आई0टी0आई0, सैदपुर, बल्देव</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>बनी सिंह सिकरवार प्राइवेट आई0टी0आई0, महावन</td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>आर0बी0एस0 प्राइवेट आई0टी0आई0, मदौरा बल्देव</td>
                                                        <td>03-05-2023</td>
                                                    </tr>
                                                    <!--<tr><td>मथुरा</td><td>टी0एस0 प्राइवेट आई0टी0आई0, इंदावली, बल्देव </td><td>03-05-2023</td></tr>-->
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>सोबरन सिंह प्राइवेट आई0टी0आई0</td>
                                                        <td>09-08-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>अनंत प्राइवेट आई0टी0आई0</td>
                                                        <td>09-08-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>बी0एस0पी0 प्राइवेट आई0टी0आई0</td>
                                                        <td>09-08-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>श्री शंकर सिंह प्राइवेट आई0टी0आई0</td>
                                                        <td>09-08-2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>मथुरा</td>
                                                        <td>अमर प्राइवेट, आई0टी0आई0, राया</td>
                                                        <td>09-08-2023</td>
                                                    </tr>
                                        ...
                                        <div class="gen-list no-border no-bg padding-0 border-radius-none square-list  col-two normal-font  ">
                                            ...
                                            <ul>
                                                ...
                                                <li class="  ">
                                                    <a href="http://www.ujala.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">Ujjwala Yojana</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
