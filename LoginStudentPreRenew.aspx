<%@ Page Title="" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="LoginStudentPreRenew.aspx.cs" Inherits="LoginStudentPreRenew" %>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div id="breadcrumb" class="push-left" role="navigation" aria-label="breadcrumb">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span>Login Renew (Prematric)</span>
                                </li>
                            </ul>
                            <!-- .breadcrumbs -->
                        </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 brdrtheme2" style="border-radius: 15px; box-shadow:inset 11px 20em 32em 25em rgba(201, 224, 234, 0.4), 0 3.3em rgba(201, 224, 234,0.4); ">
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 form-group" style="text-align: left; margin-bottom: 6px;">
                                ...
                                <div class="col-md-7 col-sm-7 col-lg-7 col-xl-7 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox type="text" MaxLength="10" ID="rbtnFR" TabIndex="2" CssClass="txtbox form-control" autocomplete="off" Style="" runat="server" ReadOnly="true" Text="नवीनीकरण (Renewal)" />
                                    </div>
                                </div>
                                <br />
                                <br />
                                ...
                                <div class="col-md-7 col-sm-7 col-lg-7 col-xl-7 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox type="text" MaxLength="10" ID="rbtnLoginType" TabIndex="2" CssClass="txtbox form-control input-sm" autocomplete="off" Style="" runat="server" ReadOnly="true" Text="पूर्व दशम (Prematric)  " />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-lg-12 col-xl-12 row" style="text-align: center">
                            <div class="form-group col-md-12 col-sm-12 col-lg-12 col-xl-12 row">
                                <input type="submit" name="ctl00$ContentPlaceHolder1$btnLogin" value="Submit" onclick=" return check();" id="ContentPlaceHolder1_btnLogin" tabindex="5" class="btn-success btn" style="width: 150px; border-radius: 6px; color: white;" />
                            </div>
