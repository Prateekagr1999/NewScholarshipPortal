<%@ Page Title="" Language="C#" MasterPageFile="SecondMasterPage.master" AutoEventWireup="true" CodeFile="InstituteAddNew.aspx.cs" Inherits="InstituteAddNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div id="breadcrumb" class="push-left" role="navigation" aria-label="breadcrumb">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span>Postmetric Otherthan Inter</span>
                                </li>
                            </ul>
                            <!-- .breadcrumbs -->
                        </div>
            ...
            <div id="row-content" style="padding-left: 15%; padding-right: 15%; font-size: 16px; border: 1px solid white; border-radius: 10px; box-shadow: 0 0 10px rgb(0 0 0 / 15%); padding: 20px 46px 60px;">
                ...
                <div class="step active" id="step1">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <asp:DropDownList runat="server" ClientIDMode="Static" CssClass="form-control dropdown" ID="instType">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <asp:DropDownList CssClass="form-control dropdown" runat="server" ClientIDMode="Static" ID="Min" RepeatColumns="2" required="">
                                <asp:ListItem Selected="True" Value="0">No</asp:ListItem>
                                <asp:ListItem Value="1">Yes</asp:ListItem>
                            </asp:DropDownList>
                            <div class="error-message" id="error-Min"></div>
                        </div>
                        <div class="col-md-6" id="minFileUp" style="display: none;">
                            <div class="col-md-4">
                                <label>अल्पसंख्यक संबद्धता पत्र अपलोड करें:<span style="color: red;">*</span><span class="text-muted" style="font-size: 70%">(पीडीएफ में)(फ़ाइल का आकार 500kb से कम होना चाहिए)</span></label>
                            </div>
                            <div class="col-md-8    ">
                                <asp:FileUpload runat="server" ClientIDMode="Static" ID="minFile" CssClass="form-control" />
                                <div class="error-message" id="error-minFile"></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label>विश्वसंस्था आवंटित कोड:<span style="color: red;">*</span></label>
                        </div>
                        <div class="col-md-4">
                            <asp:TextBox runat="server" CssClass="form-control" ClientIDMode="Static" ID="uniCode" required="" oninput="limitNumberLength(this, 10)"></asp:TextBox>
                            <div class="error-message" id="error-uniCode"></div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label>संबद्धता राज्य:<span style="color: red;">*</span></label>
                        </div>
                        <div class="col-md-4">
                            <asp:DropDownList runat="server" CssClass="form-control" ClientIDMode="Static" ID="instAffState" required="">
                                <asp:ListItem>State</asp:ListItem>
                            </asp:DropDownList>
                            <div class="error-message" id="error-instAffState"></div>
                        </div>
                        <div class="col-md-2">
                            <label>के साथ संबद्ध:<span style="color: red;">*</span></label>
                        </div>
                        <div class="col-md-4" onload="removeClassIfExists();">
                            <asp:DropDownList runat="server" CssClass="form-control" ClientIDMode="Static" ID="instAff" required="">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                                <asp:ListItem Value="024">ALIGARH MUSLIM UNIVERSITY</asp:ListItem>
                                <asp:ListItem Value="070">Allahabad State University</asp:ListItem>
                                <asp:ListItem Value="026">Allahabad University</asp:ListItem>
                                <asp:ListItem Value="043">AMITY UNIVERSITY</asp:ListItem>
                                <asp:ListItem Value="093">ATAL BIHARI VAJPAYEE Medical UNIVERSITY ,UP</asp:ListItem>
                                <asp:ListItem Value="027">B.H.U University</asp:ListItem>
                                <asp:ListItem Value="044">BABU BANARSI DAS UNIVERSITY FAIZABAD ROAD LKO</asp:ListItem>
                            </asp:DropDownList>
                            <div class="error-message" id="error-instAff"></div>
                        </div>
                ...
                <div class="step" id="step2">
                    <center>
                        <h2 style="background: #062F4F; color: white; border-radius: 10px; padding: 5px 0px 5px 0px;">Examination Controller/Registrar's Details:</h2>
                    </center>
                    <div class="form-group row">
                        <div class="col-md-5">
    ...
    <script> function rcaptcha() { document.getElementById('Captcha').src = "captcha.ashx?id=" + Math.random(); } rcaptcha();</script>ipt>
            ...
            $(document).ready(function () {
                ...
                function validateStep(step) {
                    ...
                    if (step === 1) {
                        ...
                        isValid &= validateField($("#instType").val(), '#error-instType', 'This field is required.', 'required');
                        ...
                        isValid &= validateField($("#uniCode").val().trim(), '#error-uniCode', 'This field is required.', 'required');
                        ...
                        isValid &= validateField($("#instAff").val().trim(), '#error-instAff', 'Please select the affiliating  Agency.', 'required');
                        if ($("#Min").val() === '1') {
                            // Validate minFile if Min is 1 (Yes)
                            isValid &= validateFile($("#minFile"), 500, '#minFile', '#error-minFile');
                        }
                    } else if (step === 2) {
