<%@ Page Title="" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="status1819.aspx.cs" Inherits="status1819" %>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div id="breadcrumb" class="push-left" role="navigation" aria-label="breadcrumb">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span>Status of Session 2018-2019</span>
                                </li>
                            </ul>
                            <!-- .breadcrumbs -->
                        </div>
            ...
            <div id="row-content" class="col-md-6 col-md-offset-3 col-sm-12">
                <div class="panel panel-default brdrtheme2" style="box-shadow: 0 0 10px rgb(0 0 0 / 25%);">
                    <div class="panel-heading bgtheme" style="color: white;">
                        <h3 class="panel-title" style="font-weight: 200; line-height: 25px;">छात्रवृत्ति व शुल्क प्रतिपूर्ति सत्र-2018-19 प्रदेश में/प्रदेश से बाहर अध्ययनरत छात्र / छात्रा के ऑनलाइन आवेदन पत्र की स्थिति <span style="float: right;"><span id="lbl_date" class="label label-danger"></span></span></h3>
                    </div>
