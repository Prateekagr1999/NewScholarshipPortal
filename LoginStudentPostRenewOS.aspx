<%@ Page Title="" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="LoginStudentPostRenewOS.aspx.cs" Inherits="LoginStudentPostRenewOS" %>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div id="breadcrumb" class="push-left" role="navigation" aria-label="breadcrumb">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span>Login Renew (Postmatric Otherthan Inter) (Other State)</span>
                                </li>
                            </ul>
                            <!-- .breadcrumbs -->
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 form-group" style="text-align: left; margin-bottom: 6px;">
                                ...
                                <div class="col-md-7 col-sm-7 col-lg-7 col-xl-7 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox type="text" MaxLength="10" ID="rbtnLoginType" TabIndex="2" CssClass="txtbox form-control input-sm" autocomplete="off" Style="" runat="server" ReadOnly="true" Text="दशमोत्तर (Postmatric Otherthan Intermediate)  " />
                                    </div>
                                </div>
                            </div>
                        </div><br />
