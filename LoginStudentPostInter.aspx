<%@ Page Title="" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="LoginStudentPostInter.aspx.cs" Inherits="LoginStudentPostInter" %>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div id="breadcrumb" class="push-left" role="navigation" aria-label="breadcrumb">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span>Login Fresh (Postmatric)</span>
                                </li>
                            </ul>
                            <!-- .breadcrumbs -->
                        </div>
                ...
                <div class="panel-body">
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 brdrtheme2" style="border-radius: 15px; box-shadow:inset 11px 20em 32em 25em rgba(201, 224, 234, 0.4), 0 3.3em rgba(201, 224, 234,0.4); ">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12" style="text-align: center;">
                            <h4 class="bgtheme" style="background: white; border-radius: 20px; padding: 5px; color: white;">उ0प्र0/अन्य प्रदेश में अध्ययनरत छात्र/छात्राओं के लिए छात्रवृति एवं शुल्क प्रतिपूर्ति सत्र : <span id="ContentPlaceHolder1_lblsession">(2023-24)</span></h4>
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 form-group" style="text-align: left; margin-bottom: 6px;">
                                ...
                                <div class="col-md-7 col-sm-7 col-lg-7 col-xl-7 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox type="text" MaxLength="10" ID="rbtnLoginType" TabIndex="2" CssClass="txtbox form-control input-sm" autocomplete="off" Style="" runat="server" ReadOnly="true" Text="दशमोत्तर (Postmatric Intermediate)  " />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 form-group" style="text-align: left">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-6 inputGroupContainer">
                                    <img id="Captcha" src="captcha.ashx" alt="Captcha Loading.." style="vertical-align: middle;" />&ensp;<img onclick="rcaptcha();" id="reloadcaptcha" class="reloadcaptcha" src="image/refresh.png" alt="Refresh Captcha" />
