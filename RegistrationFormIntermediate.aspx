<%@ Page Title="" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="RegistrationFormIntermediate.aspx.cs" Inherits="RegistrationFormIntermediate" %>
    ...
    <section class="section-row">
        <div class="container">
            ...
            <div id="row-content" style="text-align: center;">
                <div class="col-md-12 brdrtheme2" style="box-shadow:inset 11px 20em 32em 25em rgba(201, 224, 234, 0.4), 0 0.2em rgba(201, 224, 234,0.4);border-radius:15px; margin: 10px;">
                    <p class="bgtheme" style="color: white; padding: 5px; border-radius: 10px; font-size: 17px; line-height:2;">
                        <b><u>दशमोत्तर छात्रवृत्ति व शुल्क प्रतिपूर्ति सत्र-(2023-24) (उ0प्र0 में कक्षा 11-12 में अध्ययनरत छात्र/छात्राओं (Fresh Student)के लिए ऑनलाइन रजिस्ट्रेशन फॉर्म)</u></b>
                    </p>

                    <div class="col-md-12">
                        <div class="panel-heading1">
                            <h3 class="panel-title" style="font-size: 1.2em; color: black; font-weight: bold; padding: 5px; text-align: left">महत्वपूर्ण दिशानिर्देश:-</h3>
                            <ol style="font-size: 15px;">
                                <li class="" style="color:black; text-align: left">रजिस्ट्रेशन फॉर्म छात्र / छात्रा द्वारा सही - सही भरा जाय। जन्मतिथि, नाम तथा पिता का नाम उपलब्ध साक्ष्य के अनुसार भरी जाय। आवेदन पत्र में तारांकित(*) बॉक्स में प्रविष्टि किया जाना अनिवार्य है|</li>
                                <li class="" style="color:black; text-align: left">सभी बाक्सों में प्रविष्टियाँ <b>अंग्रेजी भाषा के कैपिटल लैटर्स </b>में अंकित की जानी हैं|</li>
                                <li class="" style="color:black; text-align: left">पासवर्ड की लंबाई 6-12 वर्णों के बीच हो सकती है (कम से कम 1 संख्या, 1 बड़ा अक्षर, 1 विशेष वर्ण शामिल करें (@ # $ &))|</li>
                    ...
                    <div id="ContentPlaceHolder1_dvreg" class="panel-body">
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 selectContainer">
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="ddl_district" TabIndex="1" CssClass="txtbox dropdown  validate[required] form-control " runat="server"></asp:DropDownList>
                                </div>
                            ...
                            <div class="col-md-4 selectContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <asp:DropDownList runat="server" TabIndex="2" ID="ddl_institute">
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 selectContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <asp:DropDownList ID="ddl_caste" TabIndex="3" CssClass="txtbox dropdown inp-form validate[required] form-control input-sm" runat="server" Style="padding-top: 0px;">
                            ...
                            <div class="col-md-4 selectContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <asp:DropDownList ID="ddl_relegion" TabIndex="4" CssClass="input-control txtbox dropdown  validate[required] form-control input-sm" runat="server" Style="padding-top: 0px;">
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txt_studentname" MaxLength="50" runat="server" TabIndex="5" CssClass="txtbox form-control input-sm validate[required,custom[onlyLetterSp]]" AutoCompleteType="Disabled" onkeypress="return onKeyValidate(event,alpha);" Style="margin-bottom: 0px; text-transform: uppercase"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txt_mobileno" TextMode="Number" MaxLength="6" CssClass="form-control" onkeypress="return isNumber(event)" AutoCompleteType="Disabled" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <asp:DropDownList ID="ddl_highschpassyear" runat="server" TabIndex="7" CssClass="txtbox dropdown form-control validate[required]">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <asp:DropDownList ID="ddl_board" runat="server" TabIndex="8" CssClass="txtbox dropdown form-control validate[required]">
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="form-group col-md-2 col-sm-2">
                                <asp:TextBox runat="server" ID="txt_hghrollnoA" MaxLength="2" TabIndex="9" CssClass="txtbox form-control input-sm validate[required,custom[onlyLetterSp]]" ToolTip="Enter only Alphabet if exist in roll no." Style="margin-bottom: 0px; text-transform: uppercase; float: left;"></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                &nbsp;<asp:TextBox ID="txt_hghrollno" MaxLength="11" TabIndex="10" CssClass="txtbox form-control input-sm validate[custom[leng]]" TextMode="Number" onkeypress="return isNumber(event)" Style="float: right;" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txt_pwd" TextMode="Password" MaxLength="12" TabIndex="11" CssClass="txtbox form-control input-sm validate[required]" AutoCompleteType="Disabled" runat="server"></asp:TextBox>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group col-md-12 col-sm-12" style="overflow: auto;">
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$hf" id="ContentPlaceHolder1_hf" value="78783" />
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$hd_referrerUrl" id="ContentPlaceHolder1_hd_referrerUrl" />
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$un1" id="ContentPlaceHolder1_un1" />
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$req" id="ContentPlaceHolder1_req" />
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$HidPAss" id="ContentPlaceHolder1_HidPAss" />
                            </div>
                        </div>
