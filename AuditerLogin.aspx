<%@ Page Language="C#" MasterPageFile="SecondMasterPage.master" AutoEventWireup="true" CodeFile="AuditerLogin.aspx.cs" Inherits="AuditerLogin" %>
                    ...
                    <div class="col-sm-4">
                        <div class="card brdrtheme2" style="box-shadow: 0 0 10px rgb(0 0 0 / 45%);">
                            <div class="card-header bgtheme" style="color: white;">
                                <h4 class="text-center">Auditer Login</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="input-group" style="padding-top: 5px;">
                                    <asp:Label ID="forgtPass" CssClass="btn btn-primary pull-left" Text="Forgot Password" onclick="alert('Contact your Social Welfare Directorate')" runat="server" Style="padding: 7px 20px 7px 20px; border-radius: 5px;" />
