<%@ Page Title="" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true" CodeFile="RegistrationFormInstitute.aspx.cs" Inherits="RegistrationFormInstitute" %>
        ...
        <div class="container">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div id="breadcrumb" class="push-left" role="navigation" aria-label="breadcrumb">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span>Postmetric other than Inter (Fresh)</span>
                                </li>
                            </ul>
                            <!-- .breadcrumbs -->
                        </div>
            ...
            <div id="row-content" style="text-align: center;">
                <div class="col-md-12 brdrtheme2" style="box-shadow:inset 11px 20em 32em 25em rgba(201, 224, 234, 0.4), 0 3.3em rgba(201, 224, 234,0.4);border-radius:15px; margin: 10px;">
                    <p class="bgtheme" style="color: white; padding: 5px; border-radius: 10px; font-size: 15px;"><b><u>दशमोत्तर छात्रवृत्ति व शुल्क प्रतिपूर्ति सत्र-<span id="ContentPlaceHolder1_lblsession">2023-24</span> (उ0प्र0 में अध्ययनरत (कक्षा 11-12 के अतिरिक्त)छात्र/छात्राओं(Fresh Student) के लिए ऑनलाइन रजिस्ट्रेशन फॉर्म)</u></b></p>

                    <div class="col-md-12">
                        <div class="panel-heading1" style="background-color: #387391; border-radius:10px;">
                    ...
                    <div id="ContentPlaceHolder1_dvreg" class="panel-body">
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 selectContainer">
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="ddl_district" runat="server" TabIndex="1" CssClass="txtbox dropdown  validate[required] form-control">
                                    </asp:DropDownList>
                                </div>
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 selectContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <asp:DropDownList ID="ddl_caste" TabIndex="3" CssClass="txtbox input-control dropdown form-control validate[required]" runat="server">
                                        <asp:ListItem Selected="True" Value="">Select </asp:ListItem>
                                        <asp:ListItem Value="2">अनुसूचित जाति</asp:ListItem>
                                        <asp:ListItem Value="3">अनुसूचित जनजाति</asp:ListItem>
                                        <asp:ListItem Value="4">सामान्य वर्ग</asp:ListItem>
                                    </asp:DropDownList>
                        ...
                        <div class="col-md-12 form-group" style="text-align: left">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txt_studentname" runat="server" MaxLength="50" TabIndex="5" CssClass="txtbox form-control input-sm validate[required,custom[onlyLetterSp]]" Style="margin-bottom: 0px; text-transform: uppercase" AutoCompleteType="Disabled" onkeypress="return onKeyValidate(event,alpha);"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txt_mobileno" TextMode="Number" runat="server" TabIndex="6" CssClass="txtbox form-control input-sm validate[custom[leng]]" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                        ...
                        <div class="form-group col-md-12" style="text-align: left">
                            <label class="col-md-6 control-label" style="text-align: right">
                                ...
                                <img onclick="rcaptcha();" id="reloadcaptcha" class="reloadcaptcha" src="https://scholarship.up.gov.in/image/refresh.png" style="height: 35px; width: 35px;" alt="Refresh Captcha" /><br />
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="form-group col-md-12 col-sm-12" style="overflow: auto;">
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$hf" id="ContentPlaceHolder1_hf" value="67435" />
