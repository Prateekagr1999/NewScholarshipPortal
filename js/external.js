...
jQuery(document).ready(function ($) {
   ...
   jQuery(".colspexp_header_Toggler").click(function () {
        var jQuerycolspexp_header = jQuery(this).closest('.colspexp_header');
        var jQuerycolspexp_content = jQuerycolspexp_header.next('.colspexp_content');

        // Close all other collapses
        jQuery('.colspexp_content').not(jQuerycolspexp_content).slideUp(500);
        jQuery('.colspexp_header').not(jQuerycolspexp_header).find("span.fa").removeClass("fa-minus").addClass("fa-plus");

        // Toggle the current collapse
        jQuerycolspexp_content.slideToggle(500, function () {
            jQuerycolspexp_header.find("span.fa").toggleClass("fa-plus fa-minus");
        });
    });
