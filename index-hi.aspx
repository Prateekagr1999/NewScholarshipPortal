<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index-hi.aspx.cs" Inherits="index_hi" %>
                            ...
                            <div id="accessibility">
                                <ul id="accessibilityMenu" class="clearfix">
                                    <li class="switchTheme">
                                        <span class="fa fa-circle" style="color: maroon;" onclick="changeTheme('red');" title="Red theme"></span>
                                        &nbsp;&nbsp;
                                        <span class="fa fa-circle" style="color: green;" onclick="changeTheme('green');" title="Green theme"></span>
                                        &nbsp;&nbsp;
                                        <span class="fa fa-circle" style="color: #062F4F;" onclick="changeTheme('blue');" title="Blue theme"></span>
                                    </li>
                                    <li>
                                    ...
                                    <li class="languageCont" aria-label="Change Language">
                                        <a href="javascript:void(0);" tabindex="0" class="language link-selected" aria-label="हिन्दी  - Selected" title="हिन्दी  - Selected" role="button" data-toggle="dropdown">हिन्दी </a>
                                        <ul class="socialIcons">
                                            <li class="lang-item lang-item-55 lang-item-hi mFocus">
                                                <a lang="en" hreflang="en-IN" href="index.aspx" aria-label="English" title="English">ENGLISH</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                        <div class="logo">
                            <a href="index-hi.aspx" title="Go to home" class="site_logo" rel="home">
                ...
                <nav class="menu">
                    <ul id="menu-header-en" class="nav clearfix">
                        ...
                        <li id="menu-item-3092" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3092 has-sub">
                            <a href="students.aspx" aria-haspopup="true" aria-expanded="false">छात्र<span class="indicator"></span></a>
                            <ul aria-hidden="true" class="sub-menu">
                                <li id="menu-item-196" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-196 has-sub-child">
                                    <a href="registration.aspx" tabindex="-1">नया पंजीकरण</a>
                                </li>
                                <li id="menu-item-3088" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3088 has-sub has-sub-child">
                                    <a href="#" tabindex="-1" aria-haspopup="true" aria-expanded="false">नया लॉगिन<span class="indicator"></span></a>
                                    <ul aria-hidden="true" class="sub-menu">
                                        <li id="menu-item-310" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-310 has-sub-child">
                                            <a href="LoginStudentPreFresh.aspx" tabindex="-1">प्री-मैट्रिक छात्र</a>
                                        </li>
                                        <li id="menu-item-311" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-311 has-sub-child">
                                            <a href="LoginStudentPostInter.aspx" tabindex="-1">पोस्ट मैट्रिक छात्र</a>
                                        </li>
                                        <li id="menu-item-312" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-312 has-sub-child">
                                            <a href="LoginStudentPost.aspx" tabindex="-1">पोस्ट मैट्रिक (इंटरमीडिएट के अलावा) छात्र</a>
                                        </li>
                                        <li id="menu-item-314" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-314 has-sub-child">
                                            <a href="LoginStudentPostOS.aspx" tabindex="-1">पोस्ट मैट्रिक अन्य राज्य छात्र</a>
                                        </li>
                                    </ul>
                                </li>
                                <li id="menu-item-3088" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3088 has-sub has-sub-child">
                                    <a href="#" tabindex="-1" aria-haspopup="true" aria-expanded="false">नवीनीकरण लॉगिन<span class="indicator"></span></a>
                                    <ul aria-hidden="true" class="sub-menu">
                                        <li id="menu-item-310" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-310 has-sub-child">
                                            <a href="LoginStudentPreRenew.aspx" tabindex="-1">प्री-मैट्रिक छात्र</a>
                                        </li>
                                        <li id="menu-item-311" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-311 has-sub-child">
                                            <a href="LoginStudentPostRenewInter.aspx" tabindex="-1">पोस्ट मैट्रिक छात्र</a>
                                        </li>
                                        <li id="menu-item-312" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-312 has-sub-child">
                                            <a href="LoginStudentPostRenew.aspx" tabindex="-1">पोस्ट मैट्रिक (इंटरमीडिएट के अलावा) छात्र</a>
                                        </li>
                                        <li id="menu-item-314" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-314 has-sub-child">
                                            <a href="LoginStudentPostRenewOS.aspx" tabindex="-1">पोस्ट मैट्रिक अन्य राज्य छात्र</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li id="menu-item-3092" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3092 has-sub">
                            <a href="institutes.aspx" aria-haspopup="true" aria-expanded="false">संस्थान<span class="indicator"></span></a>
                            <ul aria-hidden="true" class="sub-menu">
                                <li id="menu-item-196" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-196 has-sub-child">
                                    <a href="instReg.aspx" tabindex="-1">नया पंजीकरण</a>
                                </li>
                                <li id="menu-item-3088" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3088 has-sub has-sub-child">
                                    <a href="#" tabindex="-1" aria-haspopup="true" aria-expanded="false">लॉगिन <span class="indicator"></span></a>
                                    <ul aria-hidden="true" class="sub-menu">
                                        <li id="menu-item-310" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-310 has-sub-child">
                                            <a href="Inst_login_SM.aspx" tabindex="-1">प्री-मैट्रिक संस्थान</a>
                                        </li>
                                        <li id="menu-item-311" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-311 has-sub-child">
                                            <a href="Inst_login_SM.aspx" tabindex="-1">पोस्ट मैट्रिक संस्थान</a>
                                        </li>
                                        <li id="menu-item-312" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-312 has-sub-child">
                                            <a href="oscollege_login.aspx" tabindex="-1">अन्य राज्य संस्थान</a>
                                        </li>
                                    </ul>
                                </li>
                                <li id="menu-item-196" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-196 has-sub-child">
                                    <a href="Univ_login_SM.aspx" tabindex="-1">विश्वविद्यालय/संबद्ध एजेंसियां लॉगिन</a>
                                </li>
                            </ul>
                        </li>
                        <li id="menu-item-63" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-63 has-sub">
                            <a href="departments.aspx" aria-haspopup="true" aria-expanded="false">विभाग<span class="indicator"></span></a>
                            <ul aria-hidden="true" class="sub-menu">
                                <li id="menu-item-3849" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3849 has-sub-child">
                                    <a href="LoginUser.aspx" tabindex="-1">माननीय मंत्री लॉगिन</a>
                                </li>
                                <li id="menu-item-3088" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3088 has-sub has-sub-child">
                                    <a href="#" tabindex="-1" aria-haspopup="true" aria-expanded="false">जिला कल्याण<span class="indicator"></span></a>
                                    <ul aria-hidden="true" class="sub-menu">
                                        <li id="menu-item-310" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-310 has-sub-child">
                                            <a href="Dsw_Obc_Dmo_Login.aspx?a=SW" tabindex="-1">जिला समाज कल्याण अधिकारी</a>
                                        </li>
                                        <li id="menu-item-311" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-311 has-sub-child">
                                            <a href="Dsw_Obc_Dmo_Login.aspx?a=OBC" tabindex="-1">जिला पिछड़ा वर्ग कल्याण अधिकारी</a>
                                        </li>
                                        <li id="menu-item-312" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-312 has-sub-child">
                                            <a href="Dsw_Obc_Dmo_Login.aspx?a=MIN" tabindex="-1">जिला अल्पसंख्यक कल्याण अधिकारी</a>
                                        </li>
                                        <li id="menu-item-314" class="menu-item menu-item-type-taxonomy menu-item-object-organization-type menu-item-314 has-sub-child">
                                            <a href="Dsw_Obc_Dmo_Login.aspx?a=ST" tabindex="-1">जिला अनुसूचित जनजाति कल्याण अधिकारी</a>
                                        </li>
                                    </ul>
                                </li>
                                <li id="menu-item-1531" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1531 has-sub-child">
                                    <a href="CommingSoon.aspx" tabindex="-1">व्यवस्थापक</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="AuditerLogin.aspx" tabindex="-1">लेखापरीक्षक</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="Mandal_Login.aspx" tabindex="-1">उप निदेशक</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="dwbmo_Login.aspx" tabindex="-1">निदेशक</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="Dios_Login.aspx" tabindex="-1">जिला विद्यालय निरीक्षक लॉगिन</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="osInst_login.aspx" tabindex="-1">अन्य राज्य व्यवस्थापक</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="Div18_login.aspx" tabindex="-1">उच्च शिक्षा संभागीय अधिकारी</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="EduDeptHodLogin.aspx" tabindex="-1">शिक्षा विभाग प्रमुख</a>
                                </li>
                            </ul>
                        </li>
                        <li id="menu-item-337" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-337 has-sub">
                            <a href="reports.aspx" aria-haspopup="true" aria-expanded="false">रिपोर्टें<span class="indicator"></span></a>
                            <ul aria-hidden="true" class="sub-menu">
                                <li id="menu-item-338" class="menu-item menu-item-type-taxonomy menu-item-object-provider menu-item-338 has-sub-child">
                                    <a href="reports.aspx" tabindex="-1">सभी सत्र के रिपोर्ट</a>
                                </li>
                            </ul>
                        </li>
                        <li id="menu-item-63" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-63 has-sub">
                            <a href="status.aspx" aria-haspopup="true" aria-expanded="false">स्थिति<span class="indicator"></span></a>
                            <ul aria-hidden="true" class="sub-menu">
                                <li id="menu-item-3849" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3849 has-sub-child">
                                    <a href="status2223.aspx" tabindex="-1">आवेदन की स्थिति 2022-23</a>
                                </li>
                                <li id="menu-item-1531" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1531 has-sub-child">
                                    <a href="status2122.aspx" tabindex="-1">आवेदन की स्थिति 2021-22</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="status2021.aspx" tabindex="-1">आवेदन की स्थिति 2020-21</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="status1920.aspx" tabindex="-1">आवेदन की स्थिति 2019-20</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="status1819.aspx" tabindex="-1">आवेदन की स्थिति 2018-19</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="status1718.aspx" tabindex="-1">आवेदन की स्थिति 2017-18</a>
                                </li>
                                <li id="menu-item-1676" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1676 has-sub-child">
                                    <a href="PreviousYrTimeTables.aspx" tabindex="-1">महत्वपूर्ण सूचना</a>
                                </li>
                            </ul>
                        </li>
                        <li id="menu-item-174" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1522">
                            <a href="CommingSoon.aspx" aria-haspopup="true" aria-expanded="false">शिकायत निवारण प्रणाली</a>
                        </li>
                        <li id="menu-item-174" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1522">
                            <a href="Contactus.aspx" aria-haspopup="true" aria-expanded="false">संपर्क करें</a>
                        </li>
                        <li id="menu-item-174" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1522">
                            <a href="help.aspx" aria-haspopup="true" aria-expanded="false">सहायता</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                ...
                                <div class="vc_column-inner vc_custom_1572839845724">
                                    <div class="wpb_wrapper">
                                        <div class="news-ticker-horizontal viewall-with-cntrls nth-flexslider color-white  title-left show-controls   ">
                                            <h2 class="pd-15 title-font-bold">नवीनतम अपडेट</h2>
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="vc_col-sm-12 bgtheme" style="color:white; margin:5px 5px 0 0;">
                                            <h2 style="position: sticky;top: 0;z-index: 1;">नोटिस बोर्ड</h2>
                                        </div>
                                                ...
                                                <center>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='students.aspx'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="images/Icons/hi/Frame 1.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='institutes.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 2.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Univ_login_SM.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 3.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Dios_Login.aspx'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 4.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Dsw_Obc_Dmo_Login.aspx?a=SW'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 5.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='dwbmo_Login.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 6.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='Mandal_Login.aspx'" style="padding: 5px; cursor: pointer">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 7.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 text-center hvr hvr-bounce-out" onclick="location.href='osInst_login.aspx'" style="padding: 5px; cursor: pointer;">
                                                        <div class="list-anchor" style="background-color: #f1f1f1 !important; border-color: #ccc !important; border-radius: 4px; padding: 10px 0 5px 0;">
                                                            <div class="list-text">
                                                                <center><img class="img-responsive" src="/images/Icons/hi/Frame 8.png" /></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </center>
                        ...
                        <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid accent-fixed-color tab-rowbg-home8 vc_custom_1579691374150 vc_column-gap-30">
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">                                        
                                        <div class="vc_col-sm-12 bgtheme" style="color: white; margin: 5px 0 0 0;">
                                            <h2 style="position: sticky; top: 0; z-index: 1;">डाउनलोड लिंक(2023-24)</h2>
                                        </div>
                                        <div style="width: 100%; max-height: 300px; overflow-x: hidden; overflow-y: scroll; padding: 0; margin: 0;">
                                            <table class="table vc_table-bordered table-striped table-hover ">
                                                <thead style="color:black; font-weight:bold; position: sticky;top: 0;z-index: 1;">
                                                    <tr>
                                                        <th style="min-width:10px; max-width:15px;">क्रमांक</th>
                                                        <th scope="col">शीर्षक</th>
                                                        <th scope="col">अनुलग्नक</th>
                                                    </tr>
                                                </thead>
                            ...
                            <div class="wpb_column vc_column_cont4iner vc_col-sm-8">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="vc_col-sm-12 bgtheme" style=" color:white; margin:5px 0 0 0;">
                                            <h2 style="position: sticky;top: 0;z-index: 1;">ब्लैकलिस्टेड संस्थानों की सूची</h2>
                                        </div>
                                        <div style="width: 100%; max-height: 300px;overflow-x:hidden; overflow-y: scroll;">
                                            <table class="table">
                                                ...
                                                <tbody style="background:white; color:black;">
                                                    <tr>
                                                        <td style="min-width:15px; max-width:20px;">Hathras</td>
                                                        <td >CHAUDHARY BABULAL INSTITUTE OF TECHNOLOGY AND MANAGEMENT</td>
                                                        <td class="text-center">30 Sep 2015</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="min-width:15px; max-width:20px;">Meerut</td>
                                                        <td >EXCELLENCE COLLEGE OF PROFESSIONAL STUDIES SHASTRI NAGAR MEERUT</td>
                                                        <td class="text-center">30 Jul 2015</td>
                                                    <tr>
                                                        <td style="min-width:15px; max-width:20px;">Siddharth Nagar</td>
                                                        <td ><b>Demo Title 3</b></td>
                                                        <td class="text-center"><a href="#" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="min-width:15px; max-width:20px;">Santkabir Nagar</td>
                                                        <td ><b>Demo Title 4</b></td>
                                                        <td class="text-center"><a href="#" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="min-width:15px; max-width:20px;">Ayodhya</td>
                                                        <td ><b>Demo Title 5</b></td>
                                                        <td class="text-center"><a href="#" title="Download Notice"><span class="fa fa-download"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="min-width:15px; max-width:20px;">Lucknow</td>
                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="photo-glry-cntr flexslider   thumb-right  ">
                                            ...
                                            <div class="gallery-heading">
                                                <h2 class="title-font-bold">फोटो गैलेरी</h2>
                                            </div>
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="gen-list no-border no-bg padding-0 border-radius-none square-list  col-two normal-font  ">
                                            <h2 class="title-font-normal title-font-black">महत्वपूर्ण लिंक्स</h2>
                                            <ul>
                                                <li class="  ">
                                                    <a href="https://swachhbharatmission.gov.in/sbmcms/index.htm" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">स्वच्छ भारत मिशन</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://digitalindia.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">डिजिटल इंडिया </div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://www.mygov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">मेरी सरकार</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://www.india.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">भारत की आधिकारिक वेबसाइट</div>
                                                        </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="http://www.ujala.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">उजाला योजना</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://www.pmuy.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">उज्ज्वला योजना</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="http://poshanabhiyaan.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">पोषण अभियान </div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="http://www.up.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">यूपी सरकार की आधिकारिक वेबसाइट</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://meity.gov.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">इलेक्ट्रॉनिक्स और आईटी मंत्रालय</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://shasanadesh.up.nic.in/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">यूपी सरकार शासनादेश</div>
                                                    </a>
                                                </li>
                                                <li class="  ">
                                                    <a href="https://cmhelpline.in/up-govt-scheme/cm-yogi-helpline-number/" style="">
                                                        <span class="list-icon -bg  border-radius-round"></span>
                                                        <div class="list-text">सीएम हेल्पलाइन नं.</div>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="ad-banner-cntr  col_two">
                                            <ul>
                                                <li class="color-white    no-content " title="अल्पसंख्यक कल्याण वेबसाईट ">
                                                    <a class="hyperlikdiv" href="http://minoritywelfare.up.gov.in/en" title="अल्पसंख्यक कल्याण वेबसाईट ">
                                                        <img class="ad-bnr-img img-responsive img-thumbnail" src="images/Minority.jpg" alt="अल्पसंख्यक कल्याण वेबसाईट ">
                                                        <div class="ad-bnr-wrap">
                                                            <div class="ad-bnr-text">
                                                                <span style="color:white; padding-left:20px; padding-right:20px; background:rgba(88, 157, 191,0.8);">अल्पसंख्यक कल्याण</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="color-white    no-content " title="पिछड़ी वर्ग कल्याण वेबसाईट">
                                                    <a class="hyperlikdiv" href="https://www.backwardwelfareup.gov.in/">
                                                        <img class="ad-bnr-img img-responsive img-thumbnail" src="images/backward.jpg"  alt="पिछड़ी वर्ग कल्याण वेबसाईट">
                                                        <div class="ad-bnr-wrap">
                                                            <div class="ad-bnr-text">
                                                                <span style="color:white; padding-left:20px; padding-right:20px; background:rgba(88, 157, 191,0.8);">पिछड़ी वर्ग कल्याण</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="color-white    no-content " title="जनजातीय कल्याण वेबसाइट">
                                                    <a class="hyperlikdiv" href="https://tribal.nic.in/">
                                                        <img class="ad-bnr-img img-responsive img-thumbnail" src="images/Tribal.jpg" alt="जनजातीय कल्याण वेबसाइट">
                                                        <div class="ad-bnr-wrap">
                                                            <div class="ad-bnr-text">
                                                                <span style="color:white; padding-left:20px; padding-right:20px; background:rgba(88, 157, 191,0.8);">जनजातीय कल्याण</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="color-white    no-content ">
                                                    <a class="hyperlikdiv" href="http://samajkalyan.up.gov.in/">
                                                        <img class="ad-bnr-img img-responsive img-thumbnail" src="images/Social.jpg" alt="समाज कल्याण वेबसाईट">
                                                        <div class="ad-bnr-wrap">
                                                            <div class="ad-bnr-text">
                                                                <span style="color:white; padding-left:20px; padding-right:20px; background:rgba(88, 157, 191,0.8);">समाज कल्याण</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
