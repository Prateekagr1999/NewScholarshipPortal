<%@ Page Title="" Language="C#" MasterPageFile="SecondMasterPage.master" AutoEventWireup="true" CodeFile="InstituteAddInterNew-Retired.aspx.cs" Inherits="InstituteAddInterNew" %>
        ...
        <div class="container" id="multiStepForm">
            ...
            <div id="row-content" style="padding-left: 15%; padding-right: 15%; font-size: 16px; border: 1px solid white; border-radius: 10px; box-shadow: 0 0 10px rgb(0 0 0 / 15%); padding: 20px 46px 60px;">
                <div id="form-indicator" style="background: aliceblue; width: fit-content; padding: 5px 13px; border-radius: 10px;">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <!-- Form Indicator -->
                    <h6 style="display: inline; text-decoration: underline;">Go to step: </h6>
                    <button class="btn" id="btn1" style="border: 1px solid black;" disabled>1</button>
                    <button class="btn" id="btn2" style="border: 1px solid black;" disabled>2</button>
                    <button class="btn" id="btn3" style="border: 1px solid black;" disabled>3</button>
                    <button class="btn" id="btn4" style="border: 1px solid black;" disabled>4</button>
                </div>
                <!-- Step 1 -->
                <div class="step active" id="step1">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2" style="text-align: left;">
                            <label>विद्यालय का प्रकार:<span style="color: red;">*</span></label>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label>कृपया विद्यालय का पता लिखें:<span style="color: red;">*</span></label>
                        </div>
                        <div class="col-md-10">
                ...
                <div class="step" id="step3">
                    <center>
                        <h2 style="background: #589DBF; color:white; border-radius: 10px; padding: 5px 0px 5px 0px;">Nodal Officer's Details:</h2>
                    </center>
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label>नाम :<span style="color: red;">*</span></label>
